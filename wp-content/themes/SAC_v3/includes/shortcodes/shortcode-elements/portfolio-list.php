        ...
        if ($type == 'masonry') {
            ...
            if (have_posts()) : while (have_posts()) : the_post();
                ...
                if($hover_type == 'default') {
                    ...
                    if($show_title !== 'no') {
                        $html .= '<'.$title_tag.' itemprop="headings" class="portfolio_title entry_title"><a itemprop="url" href="' . $portfolio_link . '" '.qode_get_inline_style($title_styles).' target="'.$target.'">' . get_the_title() . '</a></'.$title_tag.'>';
                    }
                        ...
                        case 'thin_plus_only':
                            if ( $show_icons == 'yes' || $hover_type == 'thin_plus_only' || $hover_type = 'cursor_change_hover') {
                                ...
                                if($hover_type == 'thin_plus_only') {
                                    ...
                                    if($show_title !== 'no') {
                                        $html .= '<' . $title_tag . ' itemprop="headings" class="portfolio_title entry_title"><a itemprop="url" href="' . $portfolio_link . '" '.qode_get_inline_style($title_styles).'>' . get_the_title() . '</a></' . $title_tag . '>';
                                    }
            ...
            if (have_posts()) : while (have_posts()) : the_post();
                ...
                if($hover_type == 'default') {
                    ...
                    if ($type == "standard" || $type == "standard_no_space" || $type == "masonry_with_space") {
                        ...
                        if($show_title !== 'no') {
                            $html .= '<' . $title_tag . ' itemprop="headings" class="portfolio_title entry_title"><a itemprop="url" href="' . $portfolio_link . '" target="' . $target . '" '.qode_get_inline_style($title_styles).'>' . get_the_title() . '</a></' . $title_tag . '>';
                        }
