                ...
                <?php if ( has_post_thumbnail() ) { ?>
                    <div class="post_image">
                        ...
                        <div class="post_image_inner">
							...
							<div class="post_image_title"><div class="post_image_title_inner"><div class="grid_section"><div class="section_inner"><h2 itemprop="headings" class="entry_title"><?php the_title(); ?></h2></div></div></div></div>
						</div>
                    </div>
                <?php } ?>
                    ...
                    <div class="section_inner">
                        <div class="post_text">
                            <div class="post_text_inner">
								...
								<h2 itemprop="headings" class="entry_title">
